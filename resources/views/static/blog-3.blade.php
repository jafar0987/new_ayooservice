						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/static/' . $page='#')}}">Blog 03</a></li>
								</ol>
							</div>
								...
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										<div class="item7-card-desc d-md-flex mb-5">
											<a href="{{url('/static/' . $page='#')}}" class="d-flex mr-4 mb-2"><i class="fe fe-calendar fs-16 mr-1"></i><div class="mt-0">Jan-18-2020</div></a>
											<a href="{{url('/static/' . $page='#')}}" class="d-flex mb-2"><i class="fe fe-user fs-16 mr-1"></i><div class="mt-0">Anna Ogden</div></a>
									...
									<div class="card-body">
										<div class="d-sm-flex mt-0 p-5 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
											<div class="d-flex mr-3">
												<a href="{{url('/static/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('assets/images/users/1.jpg')}}"> </a>
											</div>
											<div class="media-body">
												...
												<a href="{{url('/static/' . $page='#')}}" class="mr-2 mt-1"><span class="badge badge-primary">Helpful</span></a>
										...
										<div class="d-sm-flex p-5 sub-review-section border subsection-color br-tl-0 br-tr-0">
											<div class="d-flex mr-3">
												<a href="{{url('/static/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('assets/images/users/2.jpg')}}"> </a>
											</div>
											<div class="media-body">
										...
										<div class="d-sm-flex p-5 mt-4 border sub-review-section">
											<div class="d-flex mr-3">
												<a href="{{url('/static/' . $page='#')}}"><img class="media-object brround avatar-md" alt="64x64" src="{{URL::asset('assets/images/users/3.jpg')}}"> </a>
											</div>
											<div class="media-body">
								...
								<div class="card mb-lg-0">
									...
									<div class="card-body">
										<div class="mt-2">
											...
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-primary">Send Reply</a>
										</div>
									</div>
								</div>
							</div>
