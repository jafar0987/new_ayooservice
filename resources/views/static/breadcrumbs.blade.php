						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/static/' . $page='#')}}">Breadcrumbs</a></li>
								</ol>
							</div>
							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									...
									<div class="card-body">
										...
										<ol class="breadcrumb1">
											<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}">Home</a></li>
											<li class="breadcrumb-item1 active">Library</li>
										</ol>
										<ol class="breadcrumb1">
											<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}">Home</a></li>
											<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}">Library</a></li>
								...
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb breadcrumb-style1 mb-0">
										<li class="breadcrumb-item">
											<a href="{{url('/static/' . $page='#')}}">Home</a>
										</li>
										<li class="breadcrumb-item">
											<a href="{{url('/static/' . $page='#')}}">Library</a>
										</li>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<ol class="breadcrumb1 bg-secondary">
											<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}" class="text-white">Home</a></li>
											<li class="breadcrumb-item1 active text-white">Library</li>
										</ol>
										<ol class="breadcrumb1 bg-success">
											<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}" class="text-white">Home</a></li>
											<li class="breadcrumb-item1 text-white"><a href="{{url('/static/' . $page='#')}}" class="text-white">Library</a></li>
...
<ol class="breadcrumb1 bg-success">
	<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}" class="text-white">Home</a></li>
	<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}" class="text-white">Library</a></li>
	<li class="breadcrumb-item1 active text-white">Data</li>
</ol></script></code></pre>
								...
								<div class="card" id="breadcrumb4">
									...
									<div class="card-body">
										<nav aria-label="breadcrumb">
											...
											<ol class="breadcrumb1">
												<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}" class=""><i class="fa fa-star-o mr-2" aria-hidden="true"></i>Home</a></li>
											...
											<ol class="breadcrumb1 bg-primary mb-0">
												<li class="breadcrumb-item1"><a href="{{url('/static/' . $page='#')}}" class="text-white"><i class="fa fa-star-o mr-2 white-text" aria-hidden="true"></i>Home</a></li>
												<li class="breadcrumb-item1 text-white"><a href="{{url('/static/' . $page='#')}}" class="text-white"><i class="fa fa-star-o mr-2 white-text" aria-hidden="true"></i>Library</a></li>
								...
								<div class="card">
									...
									<div class="card-body">
										<ol class="breadcrumb breadcrumb-arrow mt-3">
											<li><a href="{{url('/static/' . $page='#')}}">Home</a></li>
											<li class="active"><span>Data</span></li>
										</ol>
										<ol class="breadcrumb breadcrumb-arrow mt-3">
											<li><a href="{{url('/static/' . $page='#')}}">Home</a></li>
											<li><a href="{{url('/static/' . $page='#')}}">Library</a></li>
											<li class="active"><span>Data</span></li>
										</ol>
										<ol class="breadcrumb breadcrumb-arrow mt-3">
											<li><a href="{{url('/static/' . $page='#')}}">Home</a></li>
											<li><a href="{{url('/static/' . $page='#')}}">Library</a></li>
											<li><a href="{{url('/static/' . $page='#')}}">Elements</a></li>
											<li class="active"><span>Data</span></li>
										</ol>
									</div>
									<div class="html-code"><i class="las la-code mr-2"></i> Html </div>
