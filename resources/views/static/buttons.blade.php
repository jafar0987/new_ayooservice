...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{url('/static/' . $page='#')}}"><i class="fe fe-server mr-2 fs-14"></i>Elements</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/static/' . $page='#')}}">Buttons</a></li>
								</ol>
							</div>
							<div class="page-rightheader">
								<div class="btn btn-list">
									<a href="{{url('/static/' . $page='#')}}" class="btn btn-info"><i class="fe fe-settings mr-1"></i> General Settings </a>
									<a href="{{url('/static/' . $page='#')}}" class="btn btn-danger"><i class="fe fe-printer mr-1"></i> Print </a>
									<a href="{{url('/static/' . $page='#')}}" class="btn btn-warning"><i class="fe fe-shopping-cart mr-1"></i> Buy Now </a>
								</div>
							</div>
						</div>
                        <!--End Page header-->
						...
						<div class="row">
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-light">Light</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-primary">Primary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-secondary">Secondary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-success">Success</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-info">Info</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-warning">Warning</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-danger">Danger</a>
										</div>
									</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element1"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-light disabled">Light</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-primary disabled">Primary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-secondary disabled">Secondary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-success disabled">Success</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-info disabled">Info</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-warning disabled">Warning</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-danger disabled">Danger</a>
										</div>
									</div>
									<div class="html-code"><i class="las la-code mr-2"></i> Html </div>
									<!---Prism Pre code-->
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element2"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-square btn-light">Light</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-square btn-primary">Primary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-square btn-secondary">Secondary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-square btn-success">Success</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-square btn-info">Info</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-square btn-warning">Warning</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-square btn-danger">Danger</a>
										</div>
									</div>
									<div class="html-code"><i class="las la-code mr-2"></i> Html </div>
									<!---Prism Pre code-->
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element3"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pill btn-light">Light</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pill btn-primary">Primary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pill btn-secondary">Secondary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pill btn-success">Success</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pill btn-info">Info</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pill btn-warning">Warning</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pill btn-danger">Danger</a>
										</div>
									</div>
									<div class="html-code"><i class="las la-code mr-2"></i> Html </div>
									<!---Prism Pre code-->
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element4"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							...
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-light">Light</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-primary">Primary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-secondary">Secondary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-success">Success</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-info">Info</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-warning">Warning</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-danger">Danger</a>
										</div>
									</div>
									<div class="html-code"><i class="las la-code mr-2"></i> Html </div>
									<!---Prism Pre code-->
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element5"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
							<div class="col-md-12 col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-light disabled">Light</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-primary disabled">Primary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-secondary disabled">Secondary</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-success disabled">Success</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-info disabled">Info</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-warning disabled">Warning</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-outline-danger disabled">Danger</a>
										</div>
									</div>
									<div class="html-code"><i class="las la-code mr-2"></i> Html </div>
									<!---Prism Pre code-->
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element6"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element7"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element71"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element8"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element9"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element10"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-blue">Blue</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-azure">Azure</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-indigo">Indigo</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-purple">Purple</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-pink">Pink</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-red">Red</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-orange">Orange</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-yellow">Yellow</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-lime">Lime</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-green">Green</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-teal">Teal</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-cyan">Cyan</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-gray">Gray</a>
											<a href="{{url('/static/' . $page='#')}}" class="btn btn-gray-dark">Dark gray</a>
										</div>
									</div>
									<div class="html-code"><i class="las la-code mr-2"></i> Html </div>
									<!---Prism Pre code-->
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element11"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element12"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element13"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
									<div class="col-md-12 col-lg-12">
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element72"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element14"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element15"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
							</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="text-wrap">
											...
											<div class="example">
												<div class="btn-list">
													<a href="{{url('/static/' . $page='#')}}" class="btn btn-primary">Save changes</a>
													<a href="{{url('/static/' . $page='#')}}" class="btn btn-secondary">Save and continue</a>
													<a href="{{url('/static/' . $page='#')}}" class="btn btn-danger">Cancel</a>
												</div>
											</div>
										</div>
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element16"><i class="las la-paste"></i></div>
</figure>
<!---Prism Pre code-->
								</div>
								<!--div-->
...
<div class="clipboard-icon" data-clipboard-target="{{url('/static/' . $page='#')}}element17"><i class="las la-paste"></i></div>
</figure>
		<!---Prism Pre code-->
								</div>
								<!--/div-->
