...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{url('/static/' . $page='#')}}"><i class="fe fe-grid mr-2 fs-14"></i>Apps</a></li>
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/static/' . $page='#')}}">Full Calendar</a></li>
								</ol>
							</div>
								...
								<div class="col-lg-3">
									<div class="card-body p-0">
										...
										<div class="card-body">
											...
											<div class="mt-5">
												<a class="btn btn-primary" href="{{url('/static/' . $page='#')}}" data-toggle="modal" data-target="#modalSetSchedule"><i class="fe fe-plus"></i> Add New Event</a>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="{{url('/static/' . $page='calendar')}}" id="mainFormCalendar" method="post" name="mainFormCalendar">
