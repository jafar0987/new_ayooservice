								...
								<div class="card">
									...
									<div class="card-body ">
										...
										<div class=" float-right">
											<a href="{{url('/static/' . $page='shop')}}" class="btn btn-info mt-2"><i class="fe fe-arrow-left"></i> Continue Shopping</a>
											<a href="{{url('/static/' . $page='cart')}}" class="btn btn-primary mt-2">Update Cart</a>
