										...
										<div class="dropdown header-message">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class="header-dropdown-list message-menu" id="message-menu">
													<a class="dropdown-item border-bottom" href="{{url('/static/' . $page='#')}}">
												...
												<div class=" text-center p-2 border-top">
													<a href="{{url('/static/' . $page='#')}}" class="">See All Messages</a>
												</div>
											</div>
										</div>
										<div class="dropdown header-notify">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class="notify-menu">
													<a href="{{url('/static/' . $page='#')}}" class="dropdown-item border-bottom d-flex pl-4">
												...
												<div class=" text-center p-2 border-top">
													<a href="{{url('/static/' . $page='#')}}" class="">View All Notifications</a>
												</div>
											</div>
										</div>
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													<a href="{{url('/static/' . $page='#')}}" class="dropdown-item text-center user pb-0 font-weight-bold">Jessica</a>
													<span class="text-center user-semi-title">Web Designer</span>
													<div class="dropdown-divider"></div>
												</div>
												<a class="dropdown-item d-flex" href="{{url('/static/' . $page='#')}}">
