			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content tx-size-sm">
					<div class="modal-body text-center">
						...
						<a class="btn btn-danger px-5" href="{{url('/static/' . $page='login-1')}}">Log Out</a>
						...
						<div class="page-header">
							<div class="page-leftheader">
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="{{url('/static/' . $page='#')}}">Session Time Out</a></li>
								</ol>
							</div>
