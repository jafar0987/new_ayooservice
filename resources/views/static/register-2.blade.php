											...
											<div class="col-9 d-block mx-auto">
												...
												<div class="form-group">
													<label class="custom-control custom-checkbox">
														...
														<span class="custom-control-label"><a href="{{url('/static/' . $page='terms')}}" class="text-white-80">Agree the Terms and policy</a></span>
													</label>
												</div>
												<div class="row">
													<div class="col-12">
													...
													<div class="col-12 text-center">
														<a href="{{url('/static/' . $page='forgot-password-2')}}" class="btn btn-link box-shadow-0 px-0 text-white-80">Forgot password?</a>
													</div>
												</div>
											</div>
										</div>
