							...
							<div class="col-md-12 wrapper wrapper-content">
								<div class="ibox card">
									...
									<div class="ibox-content card-footer text-right">
										<a href="{{url('/static/' . $page='cart')}}" class="btn btn-success">Buy Now</a>
										<a href="{{url('/static/' . $page='cart')}}" class="btn btn-primary"><i class="fe fe-shopping-cart mr-1"></i> Add to cart</a>
									</div>
								</div>
								<div class="card">
									...
									<div class="card-body">
										...
										<form class="form-horizontal  m-t-20" action="{{url('/static/' . $page='index')}}">
