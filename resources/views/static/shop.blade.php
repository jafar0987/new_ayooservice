									...
									<div class="col-xl-4">
										<div class="card item-card">
											...
											<div class="text-center pb-4 pl-4 pr-4">
												<a href="{{url('/static/' . $page='shop-des')}}" class="btn btn-primary btn-block mb-2"><i class="fe fe-eye mr-1"></i>View More</a>
												<a href="{{url('/static/' . $page='cart')}}" class="btn btn-secondary btn-block"><i class="fe fe-shopping-cart mr-1"></i>Add to Cart</a>
											</div>
										</div>
									</div>
									<div class="col-xl-4">
